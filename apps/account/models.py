...
class Profile(models.Model):
    ...
    date_of_birth: models.DateTimeField = models.DateTimeField(blank=True, null=True)
    photo: models.ImageField = models.ImageField(upload_to="users/%Y/%m/%d/", blank=True)
